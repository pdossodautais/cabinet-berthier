...
import { deleteEstimation } from "@/lib/actions/estimations";
...
export function DeleteEstimationButton({
  ...
  id: string;
  /** Redirige vers /estimations après suppression (utile depuis le détail). */
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Supprimer cette estimation ?</AlertDialogTitle>
          <AlertDialogDescription>
